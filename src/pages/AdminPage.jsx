  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="flex justify-between mb-4">
        <button onClick={handleBack} className="text-blue-600 font-semibold">← Back</button>
      ...
      <form onSubmit={handleUpload} className="bg-white p-5 rounded shadow space-y-3">
        <input className="border p-2 w-full" placeholder="Department" value={department} onChange={e => setDepartment(e.target.value)} required />
        <input className="border p-2 w-full" placeholder="Course Title" value={title} onChange={e => setTitle(e.target.value)} required />
        <input className="border p-2 w-full" placeholder="Course Code" value={courseCode} onChange={e => setCourseCode(e.target.value)} required />
        ...
        <input type="number" className="border p-2 w-full" placeholder="Year" value={year} onChange={e => setYear(e.target.value)} required />
